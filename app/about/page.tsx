...
const interests = {
  ...
  hobbies: ["Photography", "Gaming", "Reading Tech Blogs", "Learning New Technologies", "Building Side Projects"],
};
...
const experiences = [
  {
    ...
    description:
      "Contributed to the development of the HackerFab Sputter Deposition System, focusing on software integration and real-time data monitoring to improve system performance.",
  },
  {
    year: "2020-2024",
    ...
    description:
      "Mentored 20+ students in advanced mathematics, achieving a 95% student retention rate and helping the center rank 2nd in North America. Analyzed student performance data using Excel and Power BI to identify learning gaps and optimize strategies.",
  },
  {
    year: "2023-2025",
    ...
    description:
      "Designed and developed websites for local businesses and school clubs, focusing on user experience and responsive design. Optimized site performance and integrated content management systems to enhance site maintenance and scalability.",
  },
  {
    year: "2023-2024",
    ...
    description:
      "Led the development of a Qt/C++ dashboard for visualizing live robot sensor data, aiding the team in quickly diagnosing issues. Contributed to autonomous programming, achieving 90% accuracy in navigation, and optimized sensor data processing to reduce tracking error to less than 2 cm.",
  },
];
      ...
      <div className="min-h-screen p-8 md:p-16 font-mono max-w-5xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-10">
          ...
          <div className="text-center space-y-4 mb-12">
            ...
            >
              <p className={`text-gray-600 max-w-2xl mx-auto ${GeistMono.className}`}>Computer Engineering Student at University of Waterloo</p>
          ...
          <Tabs defaultValue="bio" className="w-full mb-12">
            <TabsList className="grid w-full grid-cols-3 mb-8 bg-black/[0.02] rounded-lg p-1">
              <TabsTrigger value="bio" className="data-[state=active]:bg-white data-[state=active]:scale-105 transition-all duration-200">
                Bio
              </TabsTrigger>
              <TabsTrigger value="interests" className="data-[state=active]:bg-white data-[state=active]:scale-105 transition-all duration-200">
                Interests
              </TabsTrigger>
              <TabsTrigger value="education" className="data-[state=active]:bg-white data-[state=active]:scale-105 transition-all duration-200">
                Education
              </TabsTrigger>
            </TabsList>
                ...
                <Card className="border-black/5 shadow-sm hover:shadow-md transition-all duration-300">
                  <CardContent className="p-6">
                    ...
                    <p className={`text-gray-600 leading-relaxed ${GeistMono.className}`}>
                      ...
                      Waterloo. I specialize in building modern web applications using Next.js, React, and Node.js, with a focus on creating
                      responsive and performant solutions. With expertise in modern web technologies, I focus on building performant and scalable
                      applications.
                    </p>
                  </CardContent>
                </Card>
            ...
            <TabsContent value="interests">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {["technical", "hobbies"].map((type) => (
                  <motion.div key={type} whileHover={{ y: -5 }} transition={{ type: "spring", stiffness: 400 }}>
                    <Card className="border-black/5 shadow-sm hover:shadow-md transition-all duration-300">
                      <CardContent className="p-6">
          ...
          <div className="grid gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {Object.entries(skillCategories).map(([category, skills]) => (
                <motion.div key={category} whileHover={{ y: -5 }} transition={{ type: "spring", stiffness: 400 }}>
                  <Card className="border-black/5 shadow-sm hover:shadow-md transition-all duration-300">
                    <CardContent className="p-6">
                        ...
                        {skills.map((skill) => (
                          <HoverCard key={skill.name}>
                            <HoverCardTrigger asChild>
                              <motion.div className="space-y-2 cursor-pointer" whileHover={{ x: 5 }} transition={{ type: "spring", stiffness: 400 }}>
                            ...
                            <HoverCardContent side="top" className="w-64 animate-in fade-in-0 zoom-in-95">
